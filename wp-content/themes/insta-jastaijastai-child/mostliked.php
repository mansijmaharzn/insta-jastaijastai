<?php
/* Template Name: Most Liked Page */
get_header();
require "config.php";
?>

<?php
    $select = $conn->query("SELECT * FROM posts ORDER BY likes");
    $select->execute();
...
<a href="/insta-jastaijastai/index.php/view-post?id=<?php echo $row->id; ?>" class="btn btn-info rounded-pill mt-2" style="color: black;">View Post</a>
</div>
<?php endforeach; ?>
